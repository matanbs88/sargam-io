...
const baseScore: ImportedScore = {
  ...
  keyFifths: -4,
  measures: [{ events: [{ durationDivisions: 6, midi: 65, startDivisions: 0, tie: "none" }], number: 1 }],
...
describe("validateImportedScore", () => {
  ...
  it("flags duration and parser anomalies for editorial review", () => {
    const report = validateImportedScore({
      ...baseScore,
      measures: [{ events: [{ durationDivisions: 4, midi: 65, startDivisions: 0, tie: "none" }], number: 1 }],
